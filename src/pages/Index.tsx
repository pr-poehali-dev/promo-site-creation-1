    ...
    <div className="grain min-h-screen bg-background text-foreground">
      ...
      <footer className="relative z-10 mt-8 px-6 md:px-12 py-8 border-t border-white/10 text-white/40 text-[11px] leading-relaxed font-light">
        <div className="max-w-5xl mx-auto space-y-2">
          ...
          <p>
            На сайте представлены анкеты девушек, фотогалерея и информация о форматах встреч. Каждая встреча проходит конфиденциально, с уважением к личному пространству и пожеланиям клиента.
          </p>
          <p>
            Ключевые услуги: индивидуальные встречи, сопровождение на мероприятия, приватные вечера, романтический досуг, эскорт-услуги для взрослых, услуги интимного характера 18+.
          </p>
          <p>
            Мы ценим анонимность, безопасность и качество сервиса. Все участницы старше 18 лет, услуги предоставляются исключительно совершеннолетним лицам по взаимному согласию сторон.
          </p>
          <p>
