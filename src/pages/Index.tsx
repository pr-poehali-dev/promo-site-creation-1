        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="section-hidden order-2 md:order-1">
            ...
            <div className="space-y-5 text-muted-foreground font-sans text-sm font-light leading-loose">
              <p>
                «Сладкие грёзы» — это гибкий формат досуга, созданный специально для тех моментов, когда мужчине становится скучно: после работы, в выходной день или просто в минуты застоя.
              </p>
              <p>
                Досуг предлагает набор идей, активностей и сценариев, которые можно адаптировать под любую ситуацию и настроение.
              </p>
            </div>
